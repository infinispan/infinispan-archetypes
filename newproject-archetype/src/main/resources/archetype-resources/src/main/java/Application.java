...
public class Application {
   ...
   public void asyncOperations() {
      ...
      // TIP: For more examples on using the asynchronous API, visit http://infinispan.org/docs/8.1.x/user_guide/user_guide.html#_Listeners_and_notifications_section
   }
